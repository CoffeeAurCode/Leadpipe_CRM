...
class Settings:
    ...
    # Language-locked complaint assistants (routed per tenants.preferred_language)
    VAPI_COMPLAINT_FRENCH_ASSISTANT_ID: str = os.getenv("VAPI_COMPLAINT_FRENCH_ASSISTANT_ID", "")
    VAPI_COMPLAINT_ENGLISH_ASSISTANT_ID: str = os.getenv("VAPI_COMPLAINT_ENGLISH_ASSISTANT_ID", "")
